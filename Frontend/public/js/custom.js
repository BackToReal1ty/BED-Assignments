...
$(function() {
    ...
    var addMovieLink = $(".addMovieLink");
    var addGenreLink = $(".addGenreLink");
    var deleteMovieLink = $(".deleteMovieLink");
    var deleteGenreLink = $(".deleteGenreLink");
    var profileLink = $(".profileLink");

    var loginct = $("#login-content");
    var signupct = $("#signup-content");
    var writect = $("#write-content");
    var addMoviect = $("#addmovie-content");
    var addGenrect = $("#addgenre-content");
    var deleteMoviect = $("#deletemovie-content");
    var deleteGenrect = $("#deletegenre-content");
    var profilect = $("#profile-content");
    ...
    reviewLink.on("click", function(event) {
        event.preventDefault();
        writect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
    ...
    //pop up for add movie form
    addMovieLink.on("click", function(event) {
        event.preventDefault();
        addMoviect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
    ...
    //pop up for add genre form
    addGenreLink.on("click", function(event) {
        event.preventDefault();
        addGenrect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
    ...
    //pop up for delete movie form
    deleteMovieLink.on("click", function(event) {
        event.preventDefault();
        deleteMoviect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
    ...
    //pop up for delete genre form
    deleteGenreLink.on("click", function(event) {
        event.preventDefault();
        deleteGenrect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
    ...
    //pop up for update profile form
    profileLink.on("click", function(event) {
        event.preventDefault();
        profilect.parents(overlay).addClass("openform");
        $(document).on("click", function(e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target)
